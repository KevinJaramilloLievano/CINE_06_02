...
<?php include('menuhamburguesa.php'); ?>
	...
	<div class="container">
		<h2 class="letraBlanca">
			...
			<a href="Aborrados.php" class="btn btn-success ">L. Actores Eliminados</a>
			<a href="nuevoActor.php" class="btn btn-primary state-loadingsuccess">+Agregar</a>
			<a href="reporteActor.php" class="btn btn-success">Generar reporte</a>
			<a href="respaldoGeneralActor.php" class="btn btn-primary state-loading">Respaldo general</a>
		</h2>
		  ...
		  <tbody>
			...
			while($row = $resultado->fetch_assoc())
			{
			    ...
			    <tr>
			      ...
			      <td>
			      	<a href="borrarLogicoActor.php?id=<?php echo $row['idActor'];?>">
